...
% global R_true;
% global t_true;
% q = opnp_lines.rot2quat(R_true);
%     
% Pt_Cam = R_true * [U] + repmat(t_true, 1, size(U, 2));
% 
% avg_depth = mean(Pt_Cam(3, :));
% 
% q= q/sqrt(avg_depth);
% a = q(1);
% b = q(2);
...
% d = q(4);
% 
% v = [1 a^2 a*b a*c a*d b^2 b*c b*d c^2 c*d d^2];
% t12_true = t_true(1:2) / avg_depth;
% N2 = repmat(eye(2), n, 1);
